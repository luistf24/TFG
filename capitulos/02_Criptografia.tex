...
\begin{definicion}
	Una curva definida en $\mathbb{R}$ es el conjunto de puntos del plano (x,y) que cumplen la siguiente ecuacuación:
$$
	y^2=x^3+ax+b
$$
...
\section{Intercambio de claves Diffie-Hellman usando Curvas Elípticas}
