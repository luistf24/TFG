...
Ahora para multiplicar dos elementos pertenecientes a $\mathbb{Z}_{17}$ podemos usar su logaritmo en base 2, el exponente que hay que elevar 2 para obtener el número, sumar los logaritmos y reducirlos base 13 y elevar 2 al resultado. Un ejemplo sería:
$$
...
$$
Esta es la idea que se va a seguir para optimizar las multiplicaciones y los cálculos de inversos en $\mathbb{F}_{256}$.

\begin{teorema}
	Todo cuerpo finito tiene al menos un elemento primitivo.
\end{teorema}
Salvo para $q=2$ se tiene que el número de elementos primitivos de $\mathbb{F}_q$ es $\phi(q-1)$. Para el caso $q=13$ se tiene que $\phi(12)=\phi(2^2\cdot 3)=2\cdot2=4$, luego $\mathbb{Z}_13$ tiene 4 elementos primitivos que son 2, 6, 7 y 11.
