...
\begin{itemize}
	...
	\item \textbf{Cipher-Bloc Chaining}
	\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{\emph{Cifrado ECB}}
		\begin{description}
			\item Dividimos m en $m_{[1]}...m_{[l]}$ con $m{[i]} \in \mathbb{B}^N$
			\item Para i=1,...,l hacer
			\begin{description}
				\item $c{[i]} = E_k(m[i])$
			\end{description}
		\item Devolvemos $c[{1}]...c[{l}]$
		\end{description}

		\item \textbf{\emph{Descifrado ECB}}
		\begin{description}
			\item Dividimos c en $c_{[1]}...c_{[l]}$ con $c{[i]} \in \mathbb{B}^N$
			\item Para i=1,...,l hacer
			\begin{description}
				\item $m{[i]} = D_k(c[i])$
			\end{description}
		\item Devolvemos $m[{1}]...m[{l}]$
		\end{description}
	\end{itemize}
\end{itemize}
