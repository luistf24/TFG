...
En este apartado voy a hacer una breve introducción a la criptografía simétrica y asimétrica y el uso de estas en las aplicaciones de mensajería, así como los objetivos de un criptosistema y los posibles ataques que nos servirán para entender los cifrados que utilizarán las distintas aplicaciones de mensajería y que se desarrollarán después de este.\\
...
\subsection{Ataques}
En este apartado veremos los distintos ataques que se pueden plantear en un criptosistema, supondremos que se sigue el principio de \emph{Kerckhoffs} el cual establece que el adversario conoce todos los detalles del criptosistema excepto la clave empleada.\\
...
En esta sección hablare sobre el cifrado Rijndael AES el cual es un cifrado de bloque simétrico muy utilizado actualmente por aplicaciones como \emph{Telegram}, \emph{WhatsApp} y \emph{FacebookChat} entre otras.\\
...
\begin{itemize}
	...
	\end{itemize}
		...
		\begin{figure}[htb]
			...
			\caption{Esquema del cifrado y descifrado del modo ECB}
			\label{esquemaecb}
		\end{figure}
...
\newpage
		\begin{figure}[htb]
			...
			\caption{Esquema del cifrado y descifrado del modo CBC}
			\label{esquemahtb}
		\end{figure}
...
\newpage
		\begin{figure}[htb]
			...
			\caption{Esquema del cifrado y descifrado del modo CFB}
			\label{esquemacfb}
		\end{figure}
...
\end{itemize}
		...
		\begin{figure}[htb]
			...
			\caption{Esquema del cifrado y descifrado del modo OFB}
			\label{esquemaofb}
		\end{figure}
\newpage
Las imágenes de los distintos modos de AES las he obtenido de \cite{cifradobloque}.
