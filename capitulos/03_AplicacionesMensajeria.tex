...
\begin{enumerate}
	...
	\item Por cada conjunto de claves devueltas, el emisor tiene que verificar\\ \emph{Asignature} con \emph{CURVE25519\textunderscore VERIFY \textunderscore SIGNATURE(\\I_{primary}, 0x0600 || L_{metadata} || I_{companion})}.\\
