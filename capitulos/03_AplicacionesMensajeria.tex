...
\begin{itemize}
	\item \textbf{Claves públicas}
		\begin{itemize}
			...
			\item \emph{One-Time Pre Keys}: Es una cola de pares de claves del tipo \emph{Curve25519} de un solo uso generadas en la instalación y siendo posible volver a generarlas en caso de ser necesario.
		\end{itemize}
